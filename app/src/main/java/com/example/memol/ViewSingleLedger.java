...
public class ViewSingleLedger {
    private String Image_URL,Ledger_Name, Ledger_Date , Ledger_Time , Ledger_Location ,Ledger_Price, Ledger_Description,Ledger_Currency;

    public ViewSingleLedger(String image_URL, String memo_name, String memo_date ,String ledgerPrice, String memo_time , String memo_location , String memo_description , String ledger_Currency) {
        Image_URL = image_URL;
    ...
    public String getLedger_Currency() { return Ledger_Currency; }

    public void setLedger_Currency(String ledger_Currency) { Ledger_Currency = ledger_Currency;}
